...
const Campaign = () => {
  return (
    <section className='px-4 lg:pt-41 md:pt-30 sm:pt-20 pt-10'>
      <div className='max-w-[1720px] w-full mx-auto flex flex-col  items-center justify-center'>
        ...
        <div className='flex items-center justify-center gap-[20.14px] lg:mt-16 md:mt-12 sm:mt-8 mt-6.5 flex-wrap'>
          <div className='max-w-[327.86px] hover:scale-103 duration-300 transition-all cursor-pointer w-full rounded-[22px] border border-none bg-[linear-gradient(259.08deg,#50EDFF_-5.05%,#48B8DA_63.97%,#3B5998_130.42%)] backdrop-blur-[35px] pt-[3.24px]'>
          ...
          <div className='max-w-[327.86px] hover:scale-103 duration-300 transition-all cursor-pointer w-full rounded-[22px] border border-none bg-[linear-gradient(259.08deg,#50EDFF_-5.05%,#48B8DA_63.97%,#3B5998_130.42%)] backdrop-blur-[35px] pb-[3.24px]'>
